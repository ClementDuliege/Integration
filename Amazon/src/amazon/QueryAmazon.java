...
public class QueryAmazon {
	...
	public static void mainSort() {
		...
		System.out.println("Et voici la liste de base (l‡ ou y a '-1' c'Ètait la place de valeur max): ");
	...
	// RequÍte N∞2 DEJA FINI
	public static void query2Amazon() {
		int paid_leave;
		paid_leave = QueryDaoFR.query2() + QueryDaoUSA.query2();
		System.out.println("RequÍte 2 : l'addition des congÈs = " + paid_leave + "\n");
	}
	...
	*/	
	...
	/*
	 * TU RECUP 1 ELT PAR TAB DE CHAQUE BDD DU COUP TU ME CREER 1 TAB TRIER PAR ORDRE CROISSANT EN FONCTION DE LAGE ET SI
	 * YEN A QUI ON LE MEME AGE IL FAUT QUE TU LES TRIES (DECROISSANT) PAR LEUR SALAIRES
	 */
